                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="res_name" class="form-control" placeholder="bar al nasri">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_days" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                        ...
                                                        <option value="sat-fri">sat-tue</option>
                                                        <option value="sat-thu">sat-wed</option> 
														<option value="sat-wed">sat-thu</option>
														<option value="sat-tue">sat-fri</option>
